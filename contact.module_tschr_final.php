...
$web="NA";
  ...
  switch ($key) {
    case 'page_mail':
    case 'page_copy':
      $message['subject'] .= t('[!category] !subject', $variables, array('langcode' => $language->language));/*admin*/
      ...
      $message['body'][] = "<div style='width: 720px; font-size: 15px; font-weight: bold; color: #000; margin: 40px auto ! important; padding: 10px; border: 1px solid;'>" . t('<div style="width: 720px; margin: 40px auto ! important; padding: 10px; border: 0px solid;">   <img src="http://www.tschr.com/sites/default/files/CURRENTTSCHR-05_New.png" style="margin-left: 79%;"></br>
<img src="http://sleephungry.com/assets/img/Service_related_Images.png" alt="TSC HR service" style="float: inherit;padding-top: 10px;margin-left:-7px;" /> </br>


</div>
').'Hi    '.$fn.'<br>'.'Thank you for contacting Team TSCHR.'.'<br>'.'This email confirms that we have received your request. Someone from our team will be in touch with you as quickly as possible.'.'<br><br>'.'Following are the Inquiry details you sent to us :'.'<br> <br>'.'Name:- '.$fn.'<br>'.'Email:- '.$params['mail'].'<br>'.'Message:- '.$params['message'].'<br>'.'<h2 align="center">With Regards,'.'<br>'.'Team TSC HR</h2>'.'</div>';
      break;
    ...
    case 'user_copy':
      ...
      $message['subject'] .= t('[!category] !subject', $variables, array('langcode' => $language->language));
$message['body'][] = "
<div style='width: 720px; font-size: 15px; font-weight: bold; color: #000; margin: 40px auto ! important; padding: 10px; border: 1px solid;'>" . t('<div style="width: 720px; margin: 40px auto ! important; padding: 10px; border: 0px solid;">   <img src="http://www.tschr.com/sites/default/files/CURRENTTSCHR-05_New.png" style="margin-left: 79%;"></br>
<img src="http://sleephungry.com/assets/img/Service_related_Images.png" alt="TSC HR service" style="float: inherit;padding-top: 10px;margin-left:-7px;" /> </br>

</div>
').'Hi  '.$fn.'<br><br>'.'Thank you for contacting Team TSC HR.'.'<br>'.'This email confirms that we have received your request. Someone from our team will be in touch with you as quickly as possible.'.'<br><br>'.'Following is Inquiry details you sent to us :'.'<br><br>'.'Name:-'.$fn.'<br>'.'Email:-  '.$params['mail'].'<br>'.'Message:-  '.$params['message'].'<br>'.'<h2 align="center">With Regards,'.'<br>'.'Team TSC HR</h2>'.'</div>';
