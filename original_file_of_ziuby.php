...
Thanks for contact us with ziuby.

</div>
').'Hi '.$fn.'<br>'.'Thank you for contacting Team Ziuby.'.'This email confirms that we have received your request. Someone from our team will be in touch with you as quickly as possible.'.'<br>'.'Following are the Inquiry details you sent to us :'.'<br> <br>'.'Name:- '.$fn.'<br>'.'Email:- '.$params['mail'].'<br>'.'Mobile:- '.$params['mobile'].'<br>'.'Website:- '.$params['website'].'<br>'.'Message:- '.$params['message'].'<br>'.'<h2 align="center">With Regards,'.'<br>'.'Team Ziuby (Zest Innovative U be You)</h2>'.'</div>';
      break;
...
').'Hi'.  $fn.'<br>'.'Thank you for contacting Team Ziuby.'.'This email confirms that we have received your request. Someone from our team will be in touch with you as quickly as possible.'.'<br>'.'Following is Inquiry details you sent to us :'.'<br>'.'Name:-'.$fn.'<br>'.'Email:-'.$params['mail'].'<br>'.'Mobile:-'.$params['mobile'].'<br>'.'Website:-'.$params['website'].'<br>'.'Message:-'.$params['message'].'<br>'.'<h2 align="center">With Regards,'.'<br>'.'Team Ziuby (Zest Innovative U be You)</h2>'.'</div>';
